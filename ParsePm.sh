...
Sniffer_PC=ltepc061.cig.mot.com
eNB_IP=27.132.68.73
...
rm -f /tmp/JUNK/*
cp $1/*/*PM*/*EMS* /tmp/JUNK
cp $1/*/*PM*/From_ENB/*EMS* /tmp/JUNK
cp $1/*/*PM*/From_LTEMGR/*EMS* /tmp/JUNK
cp $PREV_DATE/*/*PM*/From_LTEMGR/*EMS* /tmp/JUNK
...
do
	...
	for i in `ls $1/$hr*/*SDL*/*LTEMGR*/*.txt`
	do
