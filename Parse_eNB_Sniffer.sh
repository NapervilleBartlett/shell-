...
for enb_ip   in `grep eNB_IP /test/log/sfe/logs/CONFIG.txt | cut -c10-`
do	
	...
	# Plot 
	# echo "Plotting the sniffer log for eNB=$i="
	# perl Plot_eNB_Sniffer_Graph_AllDay.pl csv_file                                 Title                      Destination_Directory
	# perl Plot_eNB_Sniffer_Graph_AllDay.pl $1/All_Day_Sniffer_Summary_$enb_ip.txt   eNB_Sniffer_$enb_ip        $1
done
